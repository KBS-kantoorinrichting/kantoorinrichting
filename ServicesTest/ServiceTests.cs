    ...
    public class ServiceTests : DatabaseTest {
        ...
        private static IEnumerable<TestCaseData> ServiceCount {
            get {
                ...
                yield return new TestCaseData(new ServiceTestCase<ProductPlacement>(ProductPlacementService.Instance), 1);
            }
        }
        ...
        private static IEnumerable<TestCaseData> ServiceContains {
            get {
                yield return new TestCaseData(new ServiceTestCase<Room>(RoomService.Instance), new List<Room> {Room1, Room2});
                yield return new TestCaseData(new ServiceTestCase<Design>(DesignService.Instance), new List<Design> {Design1, Design2, Design3});
                yield return new TestCaseData(new ServiceTestCase<Product>(ProductService.Instance), new List<Product> {Product2, Product3, Product4});
                yield return new TestCaseData(new ServiceTestCase<ProductPlacement>(ProductPlacementService.Instance), new List<ProductPlacement> {ProductPlacement1});
            }
        }
        ...
        private static IEnumerable<TestCaseData> ServiceSaveContains {
            get {
                ...
                yield return new TestCaseData(new ServiceTestCase<ProductPlacement>(ProductPlacementService.Instance), ProductPlacement2);
            }
        }
        ...
        private static IEnumerable<TestCaseData> ServiceGetEquals {
            get {
                ...
                yield return new TestCaseData(new ServiceTestCase<ProductPlacement>(ProductPlacementService.Instance), ProductPlacement1);
            }
        }
